...
{
    public static $centuryPopular = "19th"; //to make this properties static it is added with static name
    ...
    public static function getCenturyAuthorWasPopular() //method and it is static
    {
        return self::$centuryPopular; //to access static method
    }
}

echo Author::$centuryPopular; //use scope resolution operator to access a static properties or method
echo "\n";
echo Author::getCenturyAuthorWasPopular(); //use scope resolution operator to access a static properties or method